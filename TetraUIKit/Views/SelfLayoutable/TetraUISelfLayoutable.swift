...
/// Wrapper of `UITextView` to make it  self-autolayoutable.
open class TertraUITextView: UITextView, TetraUISelfLayoutable {
  public var selfLayoutProcess: ((UIView, UIView?, [UIView]?) -> Void)?
}

/// Wrapper of `TertraUITableView` to make it  self-autolayoutable.
open class TertraUITableView: UITableView, TetraUISelfLayoutable {
  public var selfLayoutProcess: ((UIView, UIView?, [UIView]?) -> Void)?
}

/// Wrapper of `UIScrollView` to make it  self-autolayoutable.
open class TertraUIScrollView: UIScrollView, TetraUISelfLayoutable {
  public var selfLayoutProcess: ((UIView, UIView?, [UIView]?) -> Void)?
}

/// Wrapper of `UICollectionView` to make it  self-autolayoutable.
open class TertraUICollectionView: UICollectionView, TetraUISelfLayoutable {
  public var selfLayoutProcess: ((UIView, UIView?, [UIView]?) -> Void)?
}
